            ...
            <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">PENGURUS GEREJA SELURUH RESSORT (Tahun Ini)</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">234 orang</div>
                        </div>
                        <div class="col-auto">
