...
@section('title')
    <title>Data Keuangan HKBP Pardomuan</title>
@endsection

@section('main-content')

    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Keuangan HKBP Pardomuan</h1>
                ...
                <table style="font-size: 10pt" class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    @foreach($dataKeuangan as $row)
                        <tr>
                            ...
                            {{--                                </form>--}}
                            {{--                                <a href="/editKeuanganTornagodang/{{ $row -> id }}" style="color: white" class="btn btn-primary">Edit</a>--}}
                            {{--                            </td>--}}
                        </tr>
                        <?php
