...
@section('title')
    <title>Tambah Tata Ibadah Baru</title>
@endsection
                ...
                <div class="col-lg-8">
                    <div class="p-5">
                        <div class="text-center">
                            <h1 class="h4 text-gray-900 mb-4">Tambah Tata Ibadah</h1>
                        </div>
                        <form class="user" method="post" action="{{ url('addNewTataIbadahPersonalia') }}">
                            @csrf
