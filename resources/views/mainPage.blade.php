                ...
                <div class="col-md-12">
                    ...
                    <nav id="primary-nav" class="dropdown cf">
                        <ul class="dropdown menu">
                            ...
                            <li><a class="scrollTo" data-scrollTo="blog" href="#">Pengumuman</a></li>
        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <div class="banner-caption">
                    ...
                    <span>Jl. DR. Sutomo, Gg. Merpati, No. 10, Balige</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        ...
        <div class="owl-carousel owl-theme">
            <div class="item popular-item">
                <div class="thumb">
                    <img src="templ/newTemp/img/popular_item_1.jpg" alt="">
            ...
            <div class="item popular-item">
                <div class="thumb">
                    <img src="templ/newTemp/img/popular_item_2.jpg" alt="">
                    <div class="text-content">
                        <h4>Aenean dolor</h4>
            ...
            <div class="item popular-item">
                <div class="thumb">
                    <img src="templ/newTemp/img/popular_item_3.jpg" alt="">
                    <div class="text-content">
                        <h4>Nunc at quam</h4>
            ...
            <div class="item popular-item">
                <div class="thumb">
                    <img src="templ/newTemp/img/popular_item_4.jpg" alt="">
                    <div class="text-content">
            ...
            <div class="item popular-item">
                <div class="thumb">
                    <img src="templ/newTemp/img/popular_item_5.jpg" alt="">
                    <div class="text-content">
                        <h4>Lorem ipsum</h4>
        ...
        <div class="row">
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="featured-item">
                    <div class="thumb">
                        <img src="templ/newTemp/img/featured_item_1.jpg" alt="">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="featured-item">
                    <div class="thumb">
                        <img src="templ/newTemp/img/featured_item_2.jpg" alt="">
                        <div class="overlay-content">
                            <ul>
                                <li><i class="fa fa-star"></i></li>
                                <li><i class="fa fa-star"></i></li>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="featured-item">
                    <div class="thumb">
                        <img src="templ/newTemp/img/featured_item_3.jpg" alt="">
                        <div class="overlay-content">
                            <ul>
                                <li><i class="fa fa-star"></i></li>
                                <li><i class="fa fa-star"></i></li>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="service-item">
                    <div class="icon">
                        <img src="templ/newTemp/img/service_icon_1.png" alt="">
                    </div>
            ...
            <div class="col-md-4">
                <div class="service-item">
                    <div class="icon">
                        <img src="templ/newTemp/img/service_icon_2.png" alt="">
                    </div>
            ...
            <div class="col-md-4">
                <div class="service-item">
                    <div class="icon">
                        <img src="templ/newTemp/img/service_icon_3.png" alt="">
                    </div>
        ...
        <div class="row">
            <div class="col-md-5">
                <div class="about-veno">
                    <div class="logo">
                        <img src="templ/newTemp/img/footer_logo.png" alt="Venue Logo">
                    </div>
